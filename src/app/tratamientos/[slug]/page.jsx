...
const TreatmentDetail = () => {
  ...
  // Buscar el tratamiento usando la normalización
  const treatment = treatmentsCatalog.find(
    (t) => normalizeString(t.nombre) === normalizeString(slug)
  );
      ...
      <div className="container mx-auto p-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          >
            ...
            <div className="bg-white rounded-xl p-6 shadow-md">
              <h2 className="text-xl font-semibold text-[#484450] mb-4">Información Adicional</h2>
              <div className="space-y-4 text-[#466067]">
                {treatment.info_especifica.descripcion && (
                  <p><strong className="text-[#484450]">Descripción:</strong> {treatment.info_especifica.descripcion}</p>
                )}
                {treatment.info_especifica.cuidados_especiales && (
                  <p><strong className="text-[#484450]">Cuidados Especiales:</strong> {treatment.info_especifica.cuidados_especiales}</p>
                )}
                {treatment.info_especifica.observaciones && (
                  <p><strong className="text-[#484450]">Observaciones:</strong> {treatment.info_especifica.observaciones}</p>
                )}
              </div>
            </div>
          </motion.div>
